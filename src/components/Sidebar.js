...
function Sidebar() {
  return (
    <>
      <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark slide-in-left overflow-hidden">
        <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
          ...
          <div className="dropdown pb-4 dropup">
            ...
            <ul className="dropdown-menu shadow" aria-labelledby="dropdownUser1">
              <li>
                <a className="dropdown-item text-black" href="mailto:ntihindukaalpha@yahoo.com" target="/blank">
              ...
              <li>
                <a className="dropdown-item text-black" href="https://www.linkedin.com/in/ntihinduka-alpha/" target="/blank">
              ...
              <li>
                <a className="dropdown-item text-black" href="https://github.com/AlphaNtihinduka" target="/blank">
