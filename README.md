...
- [Live Demo Link](https://celadon-quokka-98e2b2.netlify.app/)
...
```sh
  cd my-folder
  git clone git@github.com:AlphaNtihinduka/alpha_portifolio_react.git
```
...
Feel free to check the [issues page](https://github.com/AlphaNtihinduka/alpha_portifolio_react/issues).
